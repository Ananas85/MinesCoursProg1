package ModType16_dev.session3.demo.fonctions.induction;
...
public class EliminationRecursion {
	...
	public static void main(String[] args) {
		...
		System.out.println(factSansRecursionNonTerminale(5, new Vide()));
		System.out.println(factSansRecursion(5, new Vide()));
		System.out.println(factSansRecursionSansContinuation(5, IntUnaryOperator.identity()));
		System.out.println(factIteratif(5));
	}
}
